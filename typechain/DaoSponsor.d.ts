...
interface DaoSponsorInterface extends ethers.utils.Interface {
  functions: {
    ...
    "sponsorIndex(uint256)": FunctionFragment;
    "sponsors(uint256)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "_lockVault", data: BytesLike): Result;
...
export class DaoSponsor extends Contract {
  ...
  sponsors(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
